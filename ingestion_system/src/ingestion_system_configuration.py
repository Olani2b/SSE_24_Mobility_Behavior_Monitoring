...
class IngestionSystemConfiguration:
    ...
    def __init__(self, json_configuration_path: str, json_schema_path: str) -> None:
        ...
        """
        print(json_configuration_path, json_schema_path, "_______________")
        print(os.path.exists('./data/ingestion_system_config.json'))  # Should print True
        print(os.path.exists('./data/ingestion_system_config_schema.json'))  # Should print True
